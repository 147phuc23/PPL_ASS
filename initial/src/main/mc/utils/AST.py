...
class VarDecl(Decl,BlockMember):
    ...
    def __str__(self):
        return "VarDecl(" + "'{}'".format(str(self.variable)) + "," + str(self.varType) + ")"
...
class BinaryOp(Expr):
    ...
    def __str__(self):
        return "BinaryOp(" + "'{}'".format(self.op) + "," + str(self.left) + "," + str(self.right) + ")"
...
class UnaryOp(Expr):
    ...
    def __str__(self):
        return "UnaryOp(" + "'{}'".format(self.op) + "," + str(self.body) + ")"
...
class Return(Stmt):
    ...
    def __str__(self):
        return "Return(" + str(("" if (self.expr is None) else str(self.expr))) + ")"
